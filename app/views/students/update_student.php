  ...
  <div class="card">
    ...
    <form action="<?= site_url('/students/update/') . $data['id'] ?>" method="post">
      <div class="input-group">
        <input type="text" name="first_name" value="<?= $data['first_name'] ?>" required placeholder=" ">
        <label for="first_name">First Name</label>
      </div>

      <div class="input-group">
        <input type="text" name="last_name" value="<?= $data['last_name'] ?>" required placeholder=" ">
        <label for="last_name">Last Name</label>
      </div>

      <div class="input-group">
        <input type="email" name="email" value="<?= $data['email'] ?>" required placeholder=" ">
